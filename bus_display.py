...
class BusDisplayApp:
    ...
    def create_setup_window(self):
        ...
        # 使用固定窗口大小，适合100%缩放比
        self.window_a.geometry("600x650")
    ...
    def create_setup_widgets(self):
        ...
        # 公交线路号输入
        tk.Label(self.window_a, text="公交线路号码：", font=("微软雅黑", 10)).pack(pady=5)
        self.bus_number_entry = tk.Entry(self.window_a, width=20, font=("微软雅黑", 12))
        self.bus_number_entry.pack(pady=2)
        
        # 车长姓名输入
        tk.Label(self.window_a, text="车长姓名：", font=("微软雅黑", 10)).pack(pady=5)
        self.driver_name_entry = tk.Entry(self.window_a, width=20, font=("微软雅黑", 12))
        self.driver_name_entry.pack(pady=2)
        
        # 星级选择
        tk.Label(self.window_a, text="车长星级：", font=("微软雅黑", 10)).pack(pady=5)
        self.star_var = tk.IntVar(value=3)
        
        star_frame = tk.Frame(self.window_a)
        star_frame.pack(pady=5)
        
        tk.Radiobutton(star_frame, text="3★", variable=self.star_var, value=3, font=("微软雅黑", 10)).pack(side='left', padx=10)
        tk.Radiobutton(star_frame, text="4★", variable=self.star_var, value=4, font=("微软雅黑", 10)).pack(side='left', padx=10)
        tk.Radiobutton(star_frame, text="5★", variable=self.star_var, value=5, font=("微软雅黑", 10)).pack(side='left', padx=10)
        ...
        self.photo_label = tk.Label(self.window_a, text="您好像啥都没选呢？程序仅在本地运行，不上传数据。", fg="gray", font=("微软雅黑", 9))
        ...
        self.station_button.pack(pady=10)
        self.station_label = tk.Label(self.window_a, text="该文件包含所运行方向所有站点，站名以换行符分隔。", fg="gray", font=("微软雅黑", 9))
    ...
    def validate_inputs(self):
        ...
        if len(self.bus_number) > 7:
            messagebox.showerror("错误", "线路号码长度不超过7个字符。")
            return False
    ...
    def draw_divider_line(self):
        ...
        divider_canvas.place(x=0, y=line_y-10)
    ...
    def init_area_a(self):
        ...
        if self.stations:
            ...
            self.destination_label.place(x=20, y=15)
        ...
        # 位于右侧
        self.transfer_label.place(relx=0.6, y=15)
    ...
    def init_area_c(self):
        ...
        photo_frame.place(relx=0.7, y=20, anchor='n')
        ...
        try:
            ...
            # 调整图片大小为3:4比例
            image = image.resize((135, 180), Image.Resampling.LANCZOS)
        ...
        self.next_station_frame.place(relx=0, rely=0.5, relwidth=1, relheight=0.4)
        ...
        self.next_station_container.pack(pady=(20, 10))
    ...
    def update_display(self):
        ...
        side_door_label.place(relx=0.95, y=15, anchor='ne')
    ...
    def show_arrival_display(self):
        ...
        # 绘制圆角矩形
        self.create_round_rect(canvas, 0, 0, 600, 60, 25, fill='#ED7D31', outline='')
    ...
    def show_full_route_display(self):
        ...
        canvas.create_polygon(
            end_x + 45, arrow_y+2,
            end_x + 45 - arrow_length, arrow_y - arrow_width+2,
            end_x + 45 - arrow_length, arrow_y+2,
            fill=self.colors['divider_orange'],
            outline=self.colors['divider_orange']
        )
        ...
        for i, station in enumerate(self.stations):
            ...
            # 如果是指向的站点，添加橙色边框
            if i == self.current_station_index:
                box_height = int(canvas_height * 0.75)
                canvas.create_rectangle(
                    x - circle_radius - 2, circle_y - circle_radius - 25,
                    x + circle_radius + 2, circle_y + box_height,
    ...
    def draw_arrow_line(self, canvas, canvas_width):
        ...
        canvas.create_polygon(
            end_x + 50, arrow_y+2,
            end_x + 50 - arrow_length, arrow_y - arrow_width+2,
            end_x + 50 - arrow_length, arrow_y+2,
            fill=self.colors['divider_orange'],
            outline=self.colors['divider_orange']
        )
    ...
    def create_control_window(self):
        ...
        self.window_c.geometry("400x200")
        ...
        y = self.window_b.winfo_y() + self.screen_height + 10
        ...
        self.arrival_button.pack(side='left', expand=True, padx=30)
        ...
        self.departure_button.pack(side='right', expand=True, padx=30)
            ...
            try:
                with open(license_file, 'r', encoding='utf-8') as f:
                    ...
                    if user_code:
                        ...
                        auth_label.pack(side='bottom', pady=2)
            except:
                pass  # 如果文件读取失败，不显示
        # 添加版权信息
        copyright_label = tk.Label(
            self.window_c,
            text="逐梦桃花源著作权所有。 供公交车迷兴趣交流，不表示真实出行建议。",
            font=("微软雅黑", 8),
            fg='gray',
            wraplength=400
        )
